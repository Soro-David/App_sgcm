    ...
    <div class="container-fluid">
        ...
        <div class="card shadow-sm mb-4">
            ...
            <div class="card-body p-4">
                ...
                <form id="depenseForm" method="POST" action="{{ route('mairie.depense.store') }}"
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-4">
                            ...
                            <input type="text" class="form-control border border-1 rounded" id="motif" name="motif"
                                required>
                        </div>
                        <div class="col-md-3 mb-4">
                            <label for="montant" class="form-label">Montant (FCFA)*</label>
                            <input type="number" step="1" class="form-control border border-1 rounded" id="montant"
                                name="montant" required>
                        </div>
                        <div class="col-md-3 mb-4">
                            <label for="date_depense" class="form-label">Date de dépense*</label>
                            <input type="date" class="form-control border border-1 rounded" id="date_depense"
                                name="date_depense" required>
                        </div>
                        <div class="col-md-3 mb-4">
                            <label for="reference" class="form-label">Référence (facultatif)</label>
                            <input type="text" class="form-control border border-1 rounded" id="reference"
                                name="reference">
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-4">
                            ...
                            <select class="form-control border border-1 rounded" id="mode_paiement" name="mode_paiement"
                                required>
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <input type="file" class="form-control border border-1 rounded" id="piece_jointe"
                                name="piece_jointe" accept="image/*,application/pdf">
                        </div>
                    </div>

                    <div class="d-flex justify-content-end mt-4">
                        <button type="submit" id="save_button" class="btn btn-primar">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="depensesTable" width="100%" cellspacing="0"
                        data-ajax-url="{{ route('mairie.depense.list') }}" data-lang-url="{{ asset('js/fr-FR.json') }}">
                        <thead>
                            <tr>
                                <th>Date</th>
                                <th>Motif</th>
