                    ...
                    <form method="POST" action="{{ route('mairie.taxe.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="frequence" id="frequence" class="form-select" required>
                                ...
                                <option value="jour" {{ old('frequence') == 'jour' ? 'selected' : '' }}>Journalier</option>
                                <option value="mois" {{ old('frequence') == 'mois' ? 'selected' : '' }}>Mensuel</option>
                        ...
                        {{-- Mairie ID (caché) --}}
                        <input type="hidden" name="mairie_id" value="{{ Auth::guard('mairie')->id() }}">

                        {{-- Boutons --}}
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('mairie.dashboard') }}" class="btn btn-secondary me-2">Annuler</a>
