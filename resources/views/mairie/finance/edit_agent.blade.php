                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <select name="type_agent" id="type_agent" class="form-select" required>
                                ...
                                <option value="agent_financier"
                                    {{ old('type_agent', $agent->role) == 'agent_financier' ? 'selected' : '' }}>Agent
                                    Financier</option>
                                <option value="caissier"
                                    {{ old('type_agent', $agent->role) == 'caissier' ? 'selected' : '' }}>Caissier
                                </option>
                            </select>
                        </div>
                        {{-- Lieu d'habitation --}}
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="text" class="form-control" id="telephone2" maxlength="10"
                                name="telephone2" value="{{ old('telephone2', $agent->telephone2) }}"
                                oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                        </div>
                        {{-- Adresse e-mail --}}
                        <div class="col-md-6 mb-4">
