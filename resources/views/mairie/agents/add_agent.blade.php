...
<div class="container d-flex align-items-center justify-content-center" style="min-height: 80vh;">
    <div class="card shadow-sm w-100">
        <div class="card-body">
            ...
            <h5 class="card-title mb-5 text-center fs-3">Ajout d'un Agent</h5>
            ...
            <form method="POST" action="{{ route('mairie.agents.store_agent') }}">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="date" class="form-control" id="date_naissance" name="date_naissance" required value="{{ old('date_naissance') }}">
                    </div>
                    {{-- Type de pièce --}}
                    <div class="col-md-6 mb-4">
                        ...
                        <select name="type_piece" id="type_piece" class="form-select" required>
                            ...
                            <option value="passport" {{ old('type_piece') == 'passport' ? 'selected' : '' }}>Passeport</option>
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="text" class="form-control" id="numero_piece" name="numero_piece" required value="{{ old('numero_piece') }}">
                    </div>
                    {{-- Type d'agent --}}
                    <div class="col-md-6 mb-4">
                        ...
                        <select name="type_agent" id="type_agent" class="form-select" required>
                            ...
                            <option value="recensement" {{ old('type_agent') == 'recenssement' ? 'selected' : '' }}>Recenssement (agent de mairie)</option>
                            <option value="recouvrement" {{ old('type_agent') == 'recouvrement' ? 'selected' : '' }}>Recouvrement</option>
                        </select>
                    </div>
                    {{-- Lieu d'habitation --}}
                    <div class="col-md-6 mb-4">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="tel" class="form-control" id="telephone1" name="telephone1" required value="{{ old('telephone1') }}">
                    </div>
                    {{-- Contact 2 --}}
                    <div class="col-md-6 mb-4">
                        <label for="telephone2" class="form-label">Contact 2</label>
                        <input type="tel" class="form-control" id="telephone2" name="telephone2" value="{{ old('telephone2') }}">
                    </div>
                      {{-- Adresse e-mail --}}
                    <div class="col-md-6 mb-4">
