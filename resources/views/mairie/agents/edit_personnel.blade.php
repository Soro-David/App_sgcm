            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('mairie.agents.update_personnel', $personnel->id) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <select name="genre" id="genre" class="form-select" required>
                                ...
                                <option value="masculin"
                                    {{ old('genre', $personnel->genre) == 'masculin' ? 'selected' : '' }}>Masculin
                                </option>
                                <option value="féminin"
                                    {{ old('genre', $personnel->genre) == 'féminin' ? 'selected' : '' }}>Féminin</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6 mb-4">
                            <x-select2-filiation :current-value="old('filiation', $personnel->filiation)" />
                        </div>
                        {{-- Contact --}}
                        <div class="col-md-6 mb-4">
                    ...
                    <div class="d-flex justify-content-end mt-4">
                        ...
                        <button type="submit" class="btn btn-primary px-5 py-2 shadow-sm">
                            <i class="fa fa-save me-2"></i> Mettre à jour le Personnel
                        </button>
                    </div>
                </form>
            </div>
