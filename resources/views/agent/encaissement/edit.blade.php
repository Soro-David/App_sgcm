                ...
                <div id="paymentDetails" style="display: none;">
                     <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="montant_par_periode" class="form-control" readonly style="font-weight: bold; background: #e9ecef;">
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="nombre_periodes" class="form-label">Nombre de périodes à payer <span class="text-danger">*</span></label>
                            <input type="number" name="nombre_periodes" id="nombre_periodes" class="form-control" min="1" required>
                            <small id="unpaid_periods_info" class="form-text text-muted"></small>
                        </div>
                    </div>
                    <div class="mb-3 bg-light p-3 rounded text-end">
                        <h4 class="mb-0">Montant Total : <span id="total_amount_display" class="fw-bold text-success">0</span> FCFA</h4>
                    </div>
