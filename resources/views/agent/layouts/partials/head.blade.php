...
<link rel="stylesheet" href="{{ asset('css/style_agent.css') }}">
<link rel="stylesheet" href="{{ asset('css/style_page.css') }}">
<link rel="stylesheet" href="{{ asset('css/modals/agent.css') }}">
...
<link href="{{ asset('assets/css/datatable-custom.css') }}" rel="stylesheet">
