...
<head>
    ...
    <title>Export Carte Virtuelle - {{ $commercant->nom }}</title>
    <style>
...
<body>
        ...
        <div class="card-front">
            ...
            <div class="card-content-wrapper">
                <div class="card-header-text text-center">
                    <h1 class="card-title text-center">CARTE DE CONTRIBUABLE</h1>
                ...
                <div class="card-body">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value">{{ $commercant->secteur->nom ?? 'Commerce Général' }}</span>
                        </div>
                        <div class="info-item">
        ...
        <div class="card-back">
            ...
            <div class="qr-container">
                @if ($commercant->qr_code_path)
                    <img src="{{ asset('storage/' . $commercant->qr_code_path) }}" alt="QR Code" class="qr-img">
                @else
            ...
            <div class="disclaimer">
                Cette carte est la propriété de l'administration fiscale locale. Elle doit être présentée lors de tout
                contrôle.
            </div>
    ...
    <div class="print-actions">
        ...
        <button class="btn-print" style="background: #4b5563;" onclick="window.history.back()">Retour</button>
    </div>
