    ...
    <div class="container d-flex justify-content-center align-items-center py-5">
        <div class="card shadow-lg p-4" style="width: 900px; border-radius: 20px; border: 1px solid #dee2e6;">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-3 text-center">
                    @if ($commercant->qr_code_path)
                        <img src="{{ asset('storage/' . $commercant->qr_code_path) }}" alt="QR Code" class="img-fluid"
            ...
            <div class="d-flex justify-content-end mt-4">
                <a href="{{ route('agent.contribuable.index') }}" class="btn btn-outline-secondary btn-sm me-2">Retour à la
                    liste</a>
