            ...
            <form id="addCommerceForm" method="POST" action="{{ route('agent.commerce.store') }}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3 mt-2">
                        <div class="col-md-7"><label for="nom" class="form-label">Nom & Prénm</label><input type="text" class="form-control" id="nom" name="nom" required value="{{ old('nom') }}"></div>
                        <div class="col-md-5"><label for="num_commerce" class="form-label">Numéro Commerce</label><input type="text" class="form-control" id="num_commerce" name="num_commerce" value="{{ $num_commerce }}" readonly></div>
                        ...
                        <div class="col-md-6"><label for="taxe_ids" class="form-label">Taxe(s) applicable(s)</label><select name="taxe_ids[]" id="taxe_ids" class="form-select select2 w-100" multiple required>@foreach ($taxes as $taxe)<option value="{{ $taxe->id }}">{{ $taxe->nom }}</option>@endforeach</select></div>
                        <div class="col-md-6"><label for="type_piece" class="form-label">Type de pièce</label><select name="type_piece" id="type_piece" class="form-select" required><option value="" disabled selected>-- Sélectionnez --</option><option value="cni">CNI</option><option value="attestation">Attestation</option><option value="passeport">Passeport</option><option value="consulaire">Consulaire</option><option value="autre">Autre</option></select></div>
                        <div class="col-md-6"><label for="numero_piece" class="form-label">N° Pièce</label><input type="text" class="form-control" id="numero_piece" name="numero_piece" value="{{ old('numero_piece') }}"></div>
                        <div class="col-md-6 d-none" id="autre_type_piece_container"><label for="autre_type_piece" class="form-label">Précisez le type de pièce</label><input type="text" class="form-control" id="autre_type_piece" name="autre_type_piece" placeholder="Type de pièce">
                    </div>
                    <div class="row g-3 mt-4">
                        <!-- Photo de Profil -->
                        <div class="col-md-4 text-center position-relative">
                            <label class="form-label">Photo de profil :</label>
                            <img id="preview_profil" src="{{ asset('images/default_avatar.jpg') }}" alt="Profil" class="img-thumbnail" style="height:120px; width:120px; object-fit: cover;">
                        ...
                        <div class="col-md-4 text-center position-relative">
                            ...
                            <img id="preview_recto" src="{{ asset('images/idrecto.jpg') }}" alt="Pièce Recto" class="img-thumbnail" style="height:120px; width:120px; object-fit: cover;">
                            <div class="position-absolute top-50 end-0 translate-middle-y me-2">
                        ...
                        <div class="col-md-4 text-center position-relative">
                            ...
                            <img id="preview_verso" src="{{ asset('images/default_piece_verso.jpg') }}" alt="Pièce Verso" class="img-thumbnail" style="height:120px; width:120px; object-fit: cover;">
                            <div class="position-absolute top-50 end-0 translate-middle-y me-2">
