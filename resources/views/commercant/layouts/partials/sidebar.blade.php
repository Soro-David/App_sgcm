<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="d-flex flex-column justify-content-between h-100">
        ...
        <ul class="nav flex-column">
            ...
            <!-- Mes Taxes -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('commercant.taches.list_tache') }}">
            ...
            <!-- Mes Taxes -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('commercant.secteurs.index') }}">
                    <i class="typcn typcn-document-text menu-icon"></i>
        ...
        <div class="mt-5 mb-3 px-3">
            <form method="POST" action="{{ route('logout.mairie') }}">
                @csrf
