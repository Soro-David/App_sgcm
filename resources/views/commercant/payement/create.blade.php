...
<div class="container d-flex justify-content-center my-5">
    <div class="card p-4 shadow" style="width: 900px; border-radius: 20px; border: 1px solid #dee2e6;">
            ...
            <form id="payment-form" method="POST" action="{{ route('commercant.payement.effectuer') }}">
                ...
                <div class="row mt-3">
                    <div class="col-md-4">
                        ...
                        <input type="number" min="1" id="nombre_periodes" name="nombre_periodes" class="form-control" required>
                    </div>
                    <div class="col-md-4">
