        ...
        <div class="login-card">
            ...
            <div class="login-left">
                ...
                <div class="left-content">
                    <h1>Boostez votre commerce local.</h1>
                    <p>Accédez à votre espace pour consulter vos taxes, effectuer vos paiements et suivre votre
                        conformité fiscale.</p>
                </div>
            ...
            <div class="login-right">
                <div class="form-header">
                    <h2>Bon retour !</h2>
                    <p>Veuillez entrer vos identifiants commerçant.</p>
                </div>

                @if ($errors->any())
                    <div class="alert alert-danger py-2" style="font-size: 14px; border-radius: 10px;">
                        <i class="fas fa-exclamation-circle me-2"></i>
                        {{ $errors->first('num_commerce', 'Identifiants invalides.') }}
                    </div>
                @endif

                <form method="POST" action="{{ route('login.commercant') }}">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group-custom">
                            ...
                            <input type="text" class="form-control" id="num_commerce" name="num_commerce"
                                placeholder="Votre numéro de commerce" required value="{{ old('num_commerce') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-options">
                        ...
                        <a href="{{ route('password.request', ['guard' => 'commercant']) }}" class="forgot-password">
                            Mot de passe oublié ?
                        </a>
                    </div>
