        ...
        <div class="card-body p-4 p-md-5">
            ...
            @if ($errors->any())
                <div class="alert alert-danger">
                    {{ $errors->first('num_commerce', 'Email ou mot de passe invalide.') }}
                </div>
            @endif
            ...
            <form method="POST" action="{{ route('login.commercant') }}">
                ...
                <div class="mb-3">
                    <label for="email" class="form-label">Numero commerce</label>
                    <input type="text" class="form-control form-control-lg" id="num_commerce" name="num_commerce"
                        required value="{{ old('num_commerce') }}">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="text-end mt-2">
                        <a href="{{ route('password.request', ['guard' => 'commercant']) }}"
                            class="text-muted small">Mot de passe oublié ?</a>
                    </div>
                </div>
