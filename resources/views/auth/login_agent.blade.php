...
<style>
    body {
        ...
        background: url("{{ asset('assets/images/login/login2.jpg') }}") no-repeat center center fixed;
            ...
            <form method="POST" action="{{ route('login.agent') }}">
                ...
                <div class="mb-4">
                    ...
                    <div class="text-end mt-2">
                        <a href="{{ route('password.request', ['guard' => 'agent']) }}" class="text-muted small">Mot de
                            passe oublié ?</a>
                    </div>
                </div>
