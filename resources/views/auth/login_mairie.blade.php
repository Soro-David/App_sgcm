...
<head>
    ...
    <title>Connexion Mairie | E-Messe</title>
        ...
        <div class="login-card">
            ...
            <div class="login-right">
                <div class="form-header">
                    <h2>Bon retour !</h2>
                    <p>Veuillez entrer vos identifiants administratifs.</p>
                </div>

                @if ($errors->any())
                    <div class="alert alert-danger py-2" style="font-size: 14px; border-radius: 10px;">
                        <i class="fas fa-exclamation-circle me-2"></i>
                        {{ $errors->first('email', 'Identifiants invalides.') }}
                    </div>
                @endif

                <form method="POST" action="{{ route('login.mairie') }}">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group-custom">
                            ...
                            <input type="email" class="form-control" id="email" name="email"
                                placeholder="votre@mairie.gouv" required value="{{ old('email') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-options">
                        ...
                        <a href="{{ route('password.request', ['guard' => 'mairie']) }}" class="forgot-password">
                            Mot de passe oublié ?
                        </a>
                    </div>
