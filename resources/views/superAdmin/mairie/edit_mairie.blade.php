            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('superadmin.mairies.update', $mairie->id) }}">
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            <label for="edit-name" class="form-label">Nom de la mairie <span
                                    class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="edit-name" name="name" required
                                value="{{ old('name', $mairie->name) }}">
                        </div>
                        <div class="col-md-6">
                            <label for="edit-email" class="form-label">Adresse e-mail <span
                                    class="text-danger">*</span></label>
                            ...
                            <select class="form-select" id="edit-region" name="region"
                                ...
                                @foreach ($regions as $region)
                                    <option value="{{ $region->region }}"
                                        {{ old('region', $mairie->region) == $region->region ? 'selected' : '' }}>
                                        {{ $region->region }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" id="edit-adresse" name="adresse"
                                value="{{ old('adresse', $mairie->adresse) }}">
                        </div>

                        <div class="col-md-6">
                            <label for="edit-telephone1" class="form-label">Téléphone 1</label>
                            <input type="text" class="form-control" id="edit-telephone1" name="telephone1" maxlength="10"
                                value="{{ old('telephone1', $mairie->telephone1) }}"
